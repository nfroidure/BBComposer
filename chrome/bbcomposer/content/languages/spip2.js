var bbcSpip2Support =
	...
	inlineMarkups : new Array('a', 'abbr', 'acronym', 'br', 'code', 'sub', 'sup', 'em', 'img', 'q', 'span', 'strong'),
	blockMarkups : new Array('h2', 'h3', 'h4', 'h5', 'h6', 'hr', 'p', 'ul', 'ol','table'),
	superblockMarkups : new Array('blockquote', 'div')
	};
bbcSpip2Support.blockLevelMarkups = [].concat(bbcSpip2Support.blockMarkups,bbcSpip2Support.superblockMarkups);
bbcSpip2Support.acceptedMarkups =
	{
	// Superblock
	"body":
		{"type":"superblock","childs":bbcSpip2Support.blockLevelMarkups},
	"blockquote":
		{"type":"superblock","childs":bbcSpip2Support.blockLevelMarkups},
	"div":
		{"type":"superblock","childs":bbcSpip2Support.blockLevelMarkups,"attributes":[{"name":"class","default":""}]},
	// Block
	"h2":
		{"type":"block","childs":bbcSpip2Support.inlineMarkups},
	"h3":
		{"type":"block","childs":bbcSpip2Support.inlineMarkups},
	"h4":
		{"type":"block","childs":bbcSpip2Support.inlineMarkups},
	...
	// Listitems
	"li":
		{"type":"list-item","childs":['ul','ol','dl'].concat(bbcSpip2Support.inlineMarkups)},
	// Inline
	"em":
		{"type":"inline","childs":bbcSpip2Support.inlineMarkups},
	"abbr":
		{"type":"inline","childs":bbcSpip2Support.inlineMarkups,"attributes":[{"name":"title","default":""}]},
	"acronym":
	...
	"br":
		{"type":"inline","childs":[]},
	"a":
		{"type":"inline","childs":bbcSpip2Support.inlineMarkups,"attributes":[{"name":"onclick","default":""},{"name":"href","default":"http://"},{"name":"title","default":""},{"name":"hreflang","default":""}]},
	"img":
	...
	"caption":
		{"type":"table-caption","childs":bbcSpip2Support.inlineMarkups},
	"thead":
	...
	"td":
		{"type":"table-cell","childs":bbcSpip2Support.inlineMarkups},
	"th":
		{"type":"table-cell","childs":bbcSpip2Support.inlineMarkups},
	"colgroup":
