var bbcMediawikiSupport =
	...
	allowedSidebars : new Array('gallery', 'kgen'),
	/* Language */
	...
	editorToSource : function (editor)
		...
		string = bbcUtils.doRegExp(string, /<img src="([^>]*)">/mg, '[[Image:$1]]');
		string = bbcUtils.doRegExp(string, /<img alt="(?:[^>]*)" src="([^>]*)">/mg, '[[Image:$1]]');
