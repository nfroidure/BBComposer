function bbcOptionService(prefBranch)
	...
	bbcOptionService.prototype.getIntOption = function (name)
		{
	...
	bbcOptionService.prototype.getBoolOption = function (name)
		{
	...
	bbcOptionService.prototype.getArrayOption = function (name)
		{
		return this.getCharOption(name).split('!');
		}
	bbcOptionService.prototype.clearOption = function (name)
		{
	...
	bbcOptionService.prototype.optionIsset = function (name)
		{
	...
	bbcOptionService.prototype.defaultOptionIsset = function (name)
		{
	...
	bbcOptionService.prototype.userOptionIsset = function (name)
		{
	...
	bbcOptionService.prototype.optionIsCached = function (name, type)
		{
		if(this.optionValue[type][name]!==undefined&&this.optionValue[type][name]!==null)
			return true
		return false;
		}
	bbcOptionService.prototype.saveOptions = function ()
		{
	...
	bbcOptionService.prototype.resetOptions = function ()
		{
		this.prefServ.resetUserPrefs();
		this.initOptions();
		}
	bbcOptionService.prototype.initOptions = function ()
		{
	...
	bbcOptionService.prototype.getIntOptions = function (branchName)
		{
		var intOptions = new Array();
		var childList = this.defaultPrefServ.getChildList(branchName,{});
		for(var i=0; i<childList.length; i++)
			{
	...
	bbcOptionService.prototype.getCharOptions = function (branchName)
		{
	...
	bbcOptionService.prototype.getDefaultCharOption = function (name)
		{
			return this.defaultPrefServ.getCharPref(name);
		}
	bbcOptionService.prototype.getListOfArrayOptions = function (branchName)
		{
